        ...
        <div class="navbar-custom">
                        ...
                        <div class="slimscroll noti-scroll">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item active">
                                <div class="notify-icon">
                                    <img src="{{ asset('adminto/dist/assets/images/users/user-1.jpg') }}"
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <div class="notify-icon">
                                    <img src="{{ asset('adminto/dist/assets/images/users/user-4.jpg') }}"
                                        class="img-fluid rounded-circle" alt="" />
                                </div>
            ...
            <div class="logo-box">
                <a href="index.html" class="logo text-center">
                    <span class="logo-lg">
                        <img src="{{ asset('adminto/dist/assets/images/logo-dark.png') }}" alt=""
                            height="16">
                        <!-- <span class="logo-lg-text-light">Xeria</span> -->
                    </span>
                    <span class="logo-sm">
                        <!-- <span class="logo-sm-text-dark">X</span> -->
                        <img src="{{ asset('adminto/dist/assets/images/logo-sm.png') }}" alt=""
                            height="24">
                    </span>
                </a>
            </div>
        ...
        <div class="left-side-menu">
            ...
            <div class="slimscroll-menu">
                ...
                <div class="user-box text-center">
                    <img src="{{ asset('adminto/dist/assets/images/users/user-1.jpg') }}" alt="user-img"
                        title="Mat Helme" class="rounded-circle img-thumbnail avatar-lg">
                    <div class="dropdown">
                        <a href="#" class="text-dark dropdown-toggle h5 mt-2 mb-1 d-block"
                            data-toggle="dropdown">Nowak Helme</a>
                    ...
                    <div class="row">
                            ...
                            <div class="card-box widget-user">
                                <div>
                                    <div class="avatar-lg float-left mr-3">
                                        <img src="{{ asset('adminto/dist/assets/images/users/user-3.jpg') }}"
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card-box widget-user">
                                <div>
                                    <div class="avatar-lg float-left mr-3">
                                        <img src="{{ asset('adminto/dist/assets/images/users/user-2.jpg') }}"
                                            class="img-fluid rounded-circle" alt="user">
                                    </div>
                                    <div class="wid-u-info">
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card-box widget-user">
                                <div>
                                    <div class="avatar-lg float-left mr-3">
                                        <img src="{{ asset('adminto/dist/assets/images/users/user-10.jpg') }}"
                                            class="img-fluid rounded-circle" alt="user">
                                    </div>
                                    <div class="wid-u-info">
                            ...
                            <div class="card-box">
                                ...
                                <div class="inbox-widget">
                                    ...
                                    <div class="inbox-item">
                                        <a href="#">
                                            <div class="inbox-item-img"><img
                                                    src="{{ asset('adminto/dist/assets/images/users/user-1.jpg') }}"
                                    ...
                                    <div class="inbox-item">
                                        <a href="#">
                                            <div class="inbox-item-img"><img
                                                    src="{{ asset('adminto/dist/assets/images/users/user-2.jpg') }}"
                                                    class="rounded-circle" alt=""></div>
                                    ...
                                    <div class="inbox-item">
                                        <a href="#">
                                            <div class="inbox-item-img"><img
                                                    src="{{ asset('adminto/dist/assets/images/users/user-3.jpg') }}"
                                                    class="rounded-circle" alt=""></div>
                                    ...
                                    <div class="inbox-item">
                                        <a href="#">
                                            <div class="inbox-item-img"><img
                                                    src="{{ asset('adminto/dist/assets/images/users/user-4.jpg') }}"
                                                    class="rounded-circle" alt=""></div>
                                    ...
                                    <div class="inbox-item">
                                        <a href="#">
                                            <div class="inbox-item-img"><img
                                                    src="{{ asset('adminto/dist/assets') }}/images/users/user-5.jpg"
                                                    class="rounded-circle" alt=""></div>
        ...
        <div class="slimscroll-menu">
            ...
            <div class="p-3">
                <div class="inbox-widget">
                    ...
                    <div class="inbox-item">
                        <div class="inbox-item-img"><img
                                src="{{ asset('adminto/dist/assets/images/users/user-6.jpg') }}"
                                class="rounded-circle" alt=""></div>
                        <p class="inbox-item-author"><a href="javascript: void(0);"
